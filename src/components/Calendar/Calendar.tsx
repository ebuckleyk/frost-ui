    ...
    <DayPicker
      ...
      className={cn(
        ...
        `
          ...
          in-data-[slot=card-content]:border-0
          in-data-[slot=card-content]:bg-transparent
          in-data-[slot=card-content]:shadow-none
          in-data-[slot=card-content]:[backdrop-filter:none]
        `,
        `
          in-data-[slot=popover-content]:rounded-none
          in-data-[slot=popover-content]:border-0
          in-data-[slot=popover-content]:bg-transparent
          in-data-[slot=popover-content]:shadow-none
          in-data-[slot=popover-content]:[backdrop-filter:none]
        `,
